...
var x=['./pages/scence/index.wxml'];d_[x[0]]={}
...
return root;
	...
	if (__vd_version_info__.delayedGwx) __wxAppCode__['pages/scence/index.wxml'] = [$gwx_XC_19, './pages/scence/index.wxml'];else __wxAppCode__['pages/scence/index.wxml'] = $gwx_XC_19( './pages/scence/index.wxml' );
	
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/scence/index.wxss'] = setCssToHead([],undefined,{path:"./pages/scence/index.wxss"});
}