...
var x=['./pages/credits/index.wxml'];d_[x[0]]={}
...
return root;
	...
	if (__vd_version_info__.delayedGwx) __wxAppCode__['pages/credits/index.wxml'] = [$gwx_XC_7, './pages/credits/index.wxml'];else __wxAppCode__['pages/credits/index.wxml'] = $gwx_XC_7( './pages/credits/index.wxml' );
	
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/credits/index.wxss'] = setCssToHead([],undefined,{path:"./pages/credits/index.wxss"});
}