...
var x=['./pages/task/task.wxml'];d_[x[0]]={}
...
return root;
	...
	if (__vd_version_info__.delayedGwx) __wxAppCode__['pages/task/task.wxml'] = [$gwx_XC_21, './pages/task/task.wxml'];else __wxAppCode__['pages/task/task.wxml'] = $gwx_XC_21( './pages/task/task.wxml' );
	
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/task/task.wxss'] = setCssToHead([],undefined,{path:"./pages/task/task.wxss"});
}